package com.shah.restfulwebservices.exception.advice;
...
import com.shah.restfulwebservices.exception.model.ErrorDetails;
...
public class CustomizedExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ErrorDetails error = new ErrorDetails(LocalDateTime.now(), "Total Errors : " + ex.getFieldErrorCount()
